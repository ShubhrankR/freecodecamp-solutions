 ...
 * ================================================
 *
 * So far we have learned to use pure functions to avoid side effects
 * in a program. Also, we have seen the value in having a function only
 ...
 * and return a function from another function. Functions are considered
 * first class objects in JavaScript, which means they can be used
 * like any other object. They can be saved in variables, stored in an
 * object, or passed as function arguments.
 *
 * Let's start with some simple array functions, which are methods on
 * the array object prototype. In this exercise we are looking at
 ...
 *
 * Q: The watchList array holds objects with information on several movies.
 * Use map on watchList to assign a new array of objects to the ratings variable.
 * Each movie in the new array should have only a title key with the name of
 * the film, and a rating key with the IMDB rating. The code in the editor
