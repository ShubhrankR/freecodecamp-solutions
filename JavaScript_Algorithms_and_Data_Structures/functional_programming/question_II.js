 ...
 * function as a parameter to be able to change the type of tea it prepares.
 * This makes getTea more flexible, and gives the programmer more control when
 * client requests change.
 *
 * But first, let's cover some functional terminology:
 * Callbacks are the functions that are slipped or passed into another
 * function to decide the invocation of that function. You may have seen them
 * passed to other methods, for example in filter, the callback function tells
