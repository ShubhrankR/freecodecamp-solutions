 ...
 *
 * JavaScript offers many predefined methods that handle common tasks so you
 * don't need to write out how the computer should perform them. For example,
 * instead of using the for loop mentioned above, you could call the map method
 * which handles the details of iterating over an array. This helps to avoid
 * semantic errors, like the "Off By One Errors" that were covered in the Debugging section.
 *
 ...
 * and closing tabs), you want to print the tabs that are still open.
 * Closed tabs are removed from the array and new tabs (for simplicity)
 * get added to the end of it.
 *
 * The code editor shows an implementation of this functionality with functions
 * for tabOpen(), tabClose(), and join(). The array tabs is part of the Window
 * object that stores the name of the open pages.
 *
 * AC -
 * ======
 * Examine the code in the editor. It's using a method that has side
 * effects in the program, causing incorrect behaviour. The final list
 * of open tabs, stored in finalTabs.tabs, should be
...
const resultGen = finalTabs.tabs;
...
console.log("Result resultGen=", resultGen);
console.log("Result expectedResult=", expectedResult);
console.log("Result 3=", resultGen === expectedResult);
