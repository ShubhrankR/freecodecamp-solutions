 ...
 * it requires. Currying a function means to convert
 * a function of N arity into N functions of arity 1.
 *
 * In other words, it restructures a function so it
 * takes one argument, then returns another function
 ...
 *
 * This is useful in your program if you can't supply all
 * the arguments to a function at one time. You can save
 * each function call into a variable, which will hold the
 * returned function reference that takes the next argument
 * when it's available. Here's an example using the curried
